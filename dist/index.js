...
class $6be4b30feeb09703$var$WheelFortune {
    static gsap;
    static customEase;
    #containerEl;
    #segmentsEl;
    ...
    constructor({ containerEl: containerEl = ".wheel", segmentsEl: segmentsEl = ".wheel__segments", buttonEl: buttonEl = ".wheel__button", rotationCount: rotationCount = 3, segmentCount: segmentCount = 8, spinStates: spinStates = [], wheelLibration: wheelLibration = false } = {}){
        this.gsap = $6be4b30feeb09703$var$WheelFortune.gsap || window.gsap;
    ...
    spin = ()=>{
        ...
        this.#tlSpin.to(this.#segmentsEl, {
            ...
            ease: $6be4b30feeb09703$var$WheelFortune.customEase.create("custom", "M0,0 C0.11,0.494 0.136,0.67 0.318,0.852 0.626,1.16 0.853,0.989 1,1"),
            rotation: `+=${rotation}`,
            duration: 3,
...
var $6be4b30feeb09703$export$2e2bcd8739ae039 = $6be4b30feeb09703$var$WheelFortune;
